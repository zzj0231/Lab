function [Loc_xyz,Index]=Qin3_Branch2_locDicaij(S_xyz,S_ref,S_varray,S_vref,fd_array,doa_ref,f_array,Qs)
 %%%情景3  %%%情景3 释放升空散射体检测到散射体 Q>1 T=1 分支2  低采
 %%%fd_array 频差矩阵 行代表组合数据，单个散射体是单列 n*3
 %%%S_ref 参考可测向散射体  S_vref 参考散射体速度  Qs:有效的散射体数量
 %%%doa_ref :可测向散射体测得的方向
